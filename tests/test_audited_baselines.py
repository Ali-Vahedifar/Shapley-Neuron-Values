...
EWC = _load('baselines/EWC', 'ewc').EWC
SI = _load('baselines/SI', 'si').SI
_pec = _load('baselines/PEC', 'pec')
PEC, PECNet = _pec.PEC, _pec.PECNet
UniCLUN = _load('baselines/UniCLUN', 'uniclun').UniCLUN
