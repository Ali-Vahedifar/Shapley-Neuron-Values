# GTEP evaluation protocol (CIFAR-100)
...
`task_local, frozen_norm_eval, bn_recal, routing=maxprob, adaptive,
adaptive_rule=coverage, adaptive_coverage=0.9`. The Shapley estimator settings
